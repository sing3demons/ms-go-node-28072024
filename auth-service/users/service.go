...
type UserService interface {
	...
	VerifyAccessToken(logger *slog.Logger, token string) error
}
...
func (u *userService) VerifyAccessToken(logger *slog.Logger, token string) error {
	logger.Info("userService VerifyAccessToken")
	...
	logger.Info("userService VerifyAccessToken", "token", t)
